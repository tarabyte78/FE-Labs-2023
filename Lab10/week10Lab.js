...
myForm.style.backgroundColor = "#D1E5F4"
myForm.style.color = "1E3F66"
...
//Answer:  Either.  But I'm more familiar with CSS right not, so that's where I lean.
...
myButton.addEventListener('mouseover', function () {
  document.body.style.backgroundColor = `rgb(${Math.random() * 125}, ${
    Math.random() * 255
  }, ${Math.random() * 255})`
})
