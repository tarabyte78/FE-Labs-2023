...
//Answer:
   //let is used the the variable may change over time. In this example, maybe cookies will change to pie.
   //const is used when the variable will not changed/reassigned.  In this example, the names of the people will not change.
...
console.log (`${myName} and ${friend} are having ${food} and ${drink}`)
